...
function OrganizationContent() {
  ...
  const [activeTab, setActiveTab] = useState<'general' | 'periods' | 'teams' | 'catalog' | 'categories' | 'whatsapp'>(
  ...
  return (
    <>
        ...
        <div className="flex flex-col gap-6 mx-auto pb-20 pt-6 max-w-7xl px-4">
        {/* PAGE CONTENT */}
